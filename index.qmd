...
- the type of terminologies managed with the software is limited to simple lists of terms, glossaries or similar. This also excludes so called [terminology management] software to manage a centralized repository of approved terms, definitions, and translations in an organization.
...
Applications without license or repository are close source. Deprecated applications are included for historical reference.
